...
/**
 * UI-only Brainstorm changes — component-level tests for the two changes:
 * STARTER_ACTIONS trimmed to exactly one entry, and normal <form>
 * semantics so pressing Enter in the custom-prompt input submits exactly
 * like clicking Ask (no separate keydown handler, no second submission
 * path).
 *
...
describe("STARTER_ACTIONS — trimmed to exactly one preset (UI-only Brainstorm changes)", () => {
...
describe("AiBrainstormPanel — starter buttons and Enter-to-submit (UI-only Brainstorm changes)", () => {
