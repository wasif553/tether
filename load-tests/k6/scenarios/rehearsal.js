/**
 * TETHER_LOAD_TEST_HARNESS_READINESS_P0_V1 — Stage: REHEARSAL (50 concurrent students).
 *
 * Run:
 *   node load-tests/setup/provisionFixture.mjs --students=60 --label=rehearsal
 *   k6 run load-tests/k6/scenarios/rehearsal.js \
...
const ACTIVE_DURATION_SECONDS = 8 * 60;
...
export const options = {
  scenarios: {
    rehearsal: {
      ...
      stages: [
        ...
        { duration: `${ACTIVE_DURATION_SECONDS}s`, target: 50 },
  ...
  tags: { stage: "rehearsal", vus: "50" },
};

function rehearsalJourney() {
  runStudentJourney({ targetDurationSeconds: ACTIVE_DURATION_SECONDS });
}

export default rehearsalJourney;
